...
- [Google's A2UI](https://a2ui.org)
- [LangChain's headless tools](https://docs.langchain.com/oss/python/langchain/frontend/headless-tools)
- [FastMCP's implementation of MCP apps](https://gofastmcp.com/apps/fastmcp-app)
